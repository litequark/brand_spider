...
try:
    ...
    for btn_alphabet_group in btn_alphabet_groups:
        ...
        container_alphabet_group = btn_city_input_box.find_element(by=By.CSS_SELECTOR,
        ...
        for wrapper_cities in wrappers_cities:
            ...
            for btn_city in btn_cities:
                ...
                '''获取城市下辖的所有区划按钮'''
                btn_districts: list = wrapper_cities.find_elements(by=By.CSS_SELECTOR,
                ...
                for btn_district in btn_districts:
                    ...
                    # 从字符串中提取数字
                    match_store_count = re.search(r"(\d+)",
                                                  str_district_total_stores) if str_district_total_stores else None
                    ...
                    for div_district_store in div_district_stores:
                        ...
                        if div_district_store.is_displayed():
                            ...
                            '''表示该元素处于下一页，需要翻页'''
                            paginator_next = driver.find_element(By.CSS_SELECTOR,
